...
table { border-spacing: 0; font-size:12px; text-align:center;vertical-align:center;}
th, td { border-top: 1px solid #d7d7d7;  border-left: 1px solid #d7d7d7;  border-bottom: 1px solid #d7d7d7;  border-right: 1px solid #d7d7d7; }
</style>
	<div class="responsive" style="padding:15px;" width="100%">
		<table class="table table-condensed" style="width:100%">
			<tr><th align='left' colspan="3" style="text-align:left;font-family: Helvetica; font-size:12px; border: none;">Report Code: Vhis 25</th></tr>
			<tr><th align="center" colspan="3" style="text-align:center;font-family: Helvetica; font-size:22px; border: none;">Kuryente Watch Reports</th></tr>
			<tr><th align="right" colspan="3" style="text-align:right;font-family: Helvetica; font-size:12px; border: none;">Report Interval: <?php echo date("m/d/Y H:i:s ",strtotime($df))." - ". date("m/d/Y H:i:s",strtotime($dt)) ?></th></tr>
		</table><br>
		<table class="table table-condensed" width="100%" style="font-family:Helvetica !important">
			<tr style='font-weight: bold; background-color:#cacaca;'>
				<th style="border-top: 1px solid #d7d7d7;  border-left: 1px solid #d7d7d7;  border-bottom: 1px solid #d7d7d7;  border-right: 1px solid #d7d7d7;font-size:12px;">Medium</th><th style="border-top: 1px solid #d7d7d7;  border-left: 1px solid #d7d7d7;  border-bottom: 1px solid #d7d7d7;  border-right: 1px solid #d7d7d7;font-size:12px;">Count of Reports Received</th><th style="border-top: 1px solid #d7d7d7;  border-left: 1px solid #d7d7d7;  border-bottom: 1px solid #d7d7d7;  border-right: 1px solid #d7d7d7;font-size:12px;">% Over Total</th>
			</tr>
			<?php $totalplus = 0; $percplus = 0;
			foreach($result as $data): ?>
			<tr id="dataResult"> <td style="border-top: 1px solid #d7d7d7;  border-left: 1px solid #d7d7d7;  border-bottom: 1px solid #d7d7d7;  border-right: 1px solid #d7d7d7;text-align:center;font-size:12px;"><?php echo $data->medium; ?></td><td style="border-top: 1px solid #d7d7d7;  border-left: 1px solid #d7d7d7;  border-bottom: 1px solid #d7d7d7;  border-right: 1px solid #d7d7d7;text-align: center;font-size:12px;"><?php echo number_format($data->total_count);$totalplus += $data->total_count; ?></td><td style="border-top: 1px solid #d7d7d7;  border-left: 1px solid #d7d7d7;  border-bottom: 1px solid #d7d7d7;  border-right: 1px solid #d7d7d7;text-align: center;font-size:12px;"><?php echo number_format($data->percentage,2);$percplus += $data->percentage; ?>%</td> </tr>
			<?php endforeach; ?>
			<tr id="dataSummary" style='font-weight: bold; background-color:#dadada;'> <th style="border-top: 1px solid #d7d7d7;  border-left: 1px solid #d7d7d7;  border-bottom: 1px solid #d7d7d7;  border-right: 1px solid #d7d7d7;font-size:12px;">TOTAL</th><th style="border-top: 1px solid #d7d7d7;  border-left: 1px solid #d7d7d7;  border-bottom: 1px solid #d7d7d7;  border-right: 1px solid #d7d7d7;font-size:12px;"><?php echo number_format($totalplus); ?></th><th style="border-top: 1px solid #d7d7d7;  border-left: 1px solid #d7d7d7;  border-bottom: 1px solid #d7d7d7;  border-right: 1px solid #d7d7d7;font-size:12px;"><?php echo number_format($percplus,2); ?>%</th></tr>
		</table>
	</div><br/>
